...
public enum Resource {
    ...
    public Optional<? extends Holder<Block>> getVanillaEquivalentBlock(ResourceType type) {
        return BuiltInRegistries.BLOCK.getHolder(ResourceLocation.withDefaultNamespace(VanillaResourceUtils.vanillaPath(this, type)));
    }

    public Optional<? extends Holder<Item>> getVanillaEquivalentItem(ResourceType type) {
        return BuiltInRegistries.ITEM.getHolder(ResourceLocation.withDefaultNamespace(VanillaResourceUtils.vanillaPath(this, type)));
    }
