...
public class DataMapGenerator extends DataMapProvider {
    ...
    protected void gather(HolderLookup.Provider provider) {
        TagKey<Item> tinyCoal = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("c", "tiny/coal"));
        TagKey<Item> tinyCharcoal = TagKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath("c", "tiny/charcoal"));
