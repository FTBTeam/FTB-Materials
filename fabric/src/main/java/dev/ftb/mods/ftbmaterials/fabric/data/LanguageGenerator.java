...
public class LanguageGenerator extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder translationBuilder) {
        ...
        for (ResourceRegistryHolder holder : ResourceRegistry.RESOURCE_REGISTRY_HOLDERS) {
            Map<XRegistryRef<Block>, Pair<Resource, ResourceType>> reverseBlockLookup = holder.getReverseBlockLookup();
            Map<XRegistryRef<Item>, Pair<Resource, ResourceType>> reverseItemLookup = holder.getReverseItemLookup();
    ...
    private <T> void createTranslations(TranslationBuilder translationBuilder, Map<XRegistryRef<T>, Pair<Resource, ResourceType>> reverseBlockLookup) {
        for (Map.Entry<XRegistryRef<T>, Pair<Resource, ResourceType>> entry : reverseBlockLookup.entrySet()) {
            ...
            ResourceKey<T> resourceKey = target.resourceKey();
